...
u16 func_80059624(u16 actor_index, f32 scale, u16* arg2) {
    ...
    for (index = 0; index < 5; index++) {
        ...
        gActors[actor_1].var_160 = Rand() * FIXED_UNIT(4.0);
        if (!(gActors[actor_index].flags & ACTOR_FLAG_FLIPPED)) {
            gActors[actor_1].var_150 = FIXED_UNIT(-16.0);
        }
        else {
            gActors[actor_1].var_150 = FIXED_UNIT(16.0);
        }
...
u16 func_8005A4B0(u16 actor_index, f32 scale) {
    ...
    gActors[actor_1].var_15C = (f32)FIXED_UNIT(0.015625) * scale;
    actor_1 = func_80059F30(actor_index, sp2C, (f64)scale, 0x14);
    if (actor_1 == 0) {
        return actor_1;
    }
...
void func_8005ACB0(u16 actor_index, u8 arg1, u8 arg2) {
    ...
    var_t2 = 0;
    var_s0 = FIXED_UNIT(256.0);
    var_v0 = 0;
    switch (arg1) {
    case 0:
        var_v1 = -10;
        var_v0 = FIXED_UNIT(64.0);
        break;
    case 8:
        var_v1 = -10;
        var_s0 = FIXED_UNIT(-256.0);
...
void func_8005BA38(u16 actor_index) {
    ...
    if ((((s32)D_8013745C + actor_index) % 5) == 0) {
        ...
        if (actor_1 != 0) {
            ...
            gActors[actor_1].var_150 = FIXED_UNIT(12.0);
