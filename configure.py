...
IDO_DEFS = f"-D_LANGUAGE_C -D_FINALROM -DF3DEX_GBI -DGAME_VERSION={GAME_VERSION.upper()} -DBUILD_VERSION=VERSION_H"
IDO_DEFS_ULTRA = "-D_FINALROM -DBUILD_VERSION=VERSION_H"
